...
from robocore.modeling.parser.mjcf_parser import element
# Copybara placeholder for internal file handling dependency.
from robocore.modeling.parser.mjcf_parser import io as resources
        ...
        try:
            ...
            if escape_separators:
                ...
                for name, value in xml_child.attrib.items():
                    # Skip unsupported attributes like 'content_type'
                ...
                # Filter out unsupported attributes like 'content_type'
                attributes = {k: v for k, v in xml_child.attrib.items() 
                             if k != 'content_type'}
