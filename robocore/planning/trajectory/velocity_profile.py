...
This module provides velocity profile generation for trajectory planning:
- Trapezoidal velocity profile (standard industrial)
- S-curve velocity profile (jerk-limited)
- Constant velocity profile

These profiles are time-optimal subject to velocity/acceleration/jerk constraints.
