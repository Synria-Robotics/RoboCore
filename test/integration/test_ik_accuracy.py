...
# -*- coding: utf-8 -*-
"""
Integration test: IK accuracy comparison between NumPy and PyTorch backends.

This test validates that PyTorch batch IK achieves comparable success rates
and accuracy to the NumPy reference implementation.
"""
