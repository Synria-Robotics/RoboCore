...
readme = (ROOT / "README.md").read_text(encoding="utf-8") if (ROOT / "README.md").exists() else "RobotCore"

init_text = (ROOT / "robotcore" / "__init__.py").read_text(encoding="utf-8")
...
setup(
    ...
    url="https://github.com/Synria-Robotics/RobotCore",  # 需要添加
    python_requires=">=3.8",
