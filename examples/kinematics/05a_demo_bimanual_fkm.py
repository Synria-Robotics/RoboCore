...
if __name__ == "__main__":
    ...
    # model_path = get_model_path("Bessica_D", version="v1_1", variant="covered_interactive", model_format="mjcf")

    parser = argparse.ArgumentParser(description="Bimanual Forward Kinematics Demo")
    parser.add_argument('--model-path', type=str, default=model_path, help='Path to robot model file (default: Alicia-M)')
    ...
    parser.add_argument('--q-left', type=float, nargs='+', default=[0.32980586939541284, 0.342077715698498, 0.3390097541227267, 0.34054373491061235, 0.3528155812136975, 0.3497476196379262],
