...
def main(args):
    ...
    beauty_print(f"Humanoid Forward Kinematics Comparison: PyTorch Kinematics vs Pinocchio vs RoboCore ({args.rc_backend})", type="module")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rc-backend', type=str, default='torch', choices=['torch', 'cpp'],
                        help='RoboCore FK backend for PK/Pin comparison')
