...
def demo_trapezoidal():
    ...
    print("\n" + "="*70)
    print("1. Trapezoidal Velocity Profile")
    print("="*70)
    ...
    print(f"  Duration: {result1['t'][-1]:.3f} s")
...
def demo_s_curve():
    ...
    print("\n" + "="*70)
    print("2. S-Curve (Jerk-Limited) Velocity Profile")
    print("="*70)
...
def plot_velocity_profiles(trap_result1, trap_result2, scurve_result, plot=False):
...
def main():
    parser = argparse.ArgumentParser(description='Velocity Profile Generation Examples')
    parser.add_argument('--plot', action='store_true', help='Show matplotlib plots')
    args = parser.parse_args()
    
    print("="*70)
    print("Velocity Profile Generation Examples")
    print("="*70)
    ...
    # Plot comparison
    plot_velocity_profiles(trap_result1, trap_result2, scurve_result, plot=args.plot)
    
    print("\n" + "="*70)
    print("✓ All examples completed!")
    print("="*70)
    print("\nUsage tips:")
    print("  • Use --plot to visualize velocity profiles")
    print("  • Trapezoidal: Simple and fast, but acceleration discontinuous")
    print("  • S-Curve: Smooth acceleration, better for vibration-sensitive applications")
    print("  • Specify duration OR (v_max and a_max) for trapezoidal")
    print("  • S-curve requires j_max (maximum jerk) for smoothness")
