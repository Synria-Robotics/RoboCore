...
Demonstrates trajectory planning capabilities in RoboCore:
...
Usage:
    python demo_trajectory.py --robot bessica --arm left
    python demo_trajectory.py --robot bessica --arm left --plot
"""
