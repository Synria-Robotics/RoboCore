...
from robotcore.planning.trajectory.joint_space import (
...
from robotcore.planning.trajectory.cartesian_space import (
    linear_cartesian_trajectory,
    circular_cartesian_trajectory,
    cartesian_waypoint_trajectory
)

from robotcore.planning.trajectory.velocity_profile import (
