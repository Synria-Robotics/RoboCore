...
from robotcore.utils.backend import get_backend
...
def bimanual_forward_kinematics(
    ...
    *,
    ...
    if mode == 'indep':
        if b == 'numpy':
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_numpy import BiIndependentFKSolverNumpy
            ...
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_torch import BiIndependentFKSolverTorch
        ...
        if b == 'numpy':
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_numpy import BiRelativeFKSolverNumpy

            solver = BiRelativeFKSolverNumpy(left_model, right_model)
            return solver.fk(q_left, q_right, backend='numpy', return_end=return_end)
        elif b == 'torch':
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_torch import BiRelativeFKSolverTorch
            import torch  # type: ignore
        ...
        if b == 'numpy':
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_numpy import BiMirrorFKSolverNumpy

            solver = BiMirrorFKSolverNumpy(left_model, right_model)
            return solver.fk(q_left, q_right, backend='numpy', return_end=return_end)
        elif b == 'torch':
            from robotcore.kinematics.fk_utils.bimanual_fk_solver_torch import BiMirrorFKSolverTorch
            import torch  # type: ignore
...
def bimanual_inverse_kinematics(
    ...
    **solver_kwargs,
    ...
    if coordination == 'indep':
        if b == 'numpy':
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_numpy import BiIndependentIKSolverNumpy
            ...
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_torch import BiIndependentIKSolverTorch
        ...
        if b == 'numpy':
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_numpy import BiRelativeIKSolverNumpy
            ...
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_torch import BiRelativeIKSolverTorch
        ...
        if b == 'numpy':
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_numpy import BiMirrorIKSolverNumpy
            ...
            from robotcore.kinematics.ik_utils.bimanual_ik_solver_torch import BiMirrorIKSolverTorch
...
def bimanual_jacobian(
    ...
    *,
    ...
    if mode == 'indep':
        if b == 'numpy':
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_numpy import BiIndependentJacobianSolverNumpy
            import numpy as np
            ...
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_torch import BiIndependentJacobianSolverTorch
            import torch  # type: ignore
        ...
        if b == 'numpy':
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_numpy import BiRelativeJacobianSolverNumpy
            import numpy as np
            ...
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_torch import BiRelativeJacobianSolverTorch
            import torch  # type: ignore
