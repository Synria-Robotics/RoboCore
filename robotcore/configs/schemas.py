"""Configuration schemas for RobotCore using dataclasses.
...
class RobotConfig:
    ...
    urdf_path: str = "robotcore/assets/robot/urdf/Alicia-D_v5_4/alicia_duo_with_gripper.urdf"
    end_link: str = "tool0"
...
class RoboCoreConfig:
    """Top-level RobotCore configuration.
