...
from robotcore.kinematics.utils import relative_pose_error, relative_jacobian
...
class RobotModel:
    ...
    def ik_tasks(self, tasks: List[Union[Dict[str, Any], Any]], q0_by_group: Dict[str, Sequence[float]], *,
        ...
        from robotcore.kinematics.solvers.multi_chain_solver import MultiChainIKSolver
        from robotcore.kinematics.task import Task
        ...
        if mode == 'weighted':
            ...
            from robotcore.kinematics.task import organize_by_priority
...
class BimanualRobotModel(RobotModel):
    ...
    def fk(self, q_left: Sequence[float], q_right: Sequence[float],
        ...
        """
        from robotcore.kinematics.bimanual import bimanual_forward_kinematics
    ...
    def ik(self, target_left=None, target_right=None,
        ...
        """
        from robotcore.kinematics.bimanual import bimanual_inverse_kinematics
    ...
    def jacobian(self, q_left: Sequence[float], q_right: Sequence[float],
        ...
        """
        from robotcore.kinematics.bimanual import bimanual_jacobian
    ...
    def block_jacobian(self, q_by_group: Dict[str, Sequence[float]], *, backend: str = 'auto') -> np.ndarray:
        ...
        b = get_backend() if backend == 'auto' else backend
        if b == 'numpy':
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_numpy import BiMultiLinkJacobianSolverNumpy
            solver = BiMultiLinkJacobianSolverNumpy(self._groups)
            return solver.block_jacobian(q_by_group, backend='numpy')
        elif b == 'torch':
            from robotcore.kinematics.jacobian_utils.bimanual_jacobian_solver_torch import BiMultiLinkJacobianSolverTorch
